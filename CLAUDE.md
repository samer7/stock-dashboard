...
## Current state (Phase 5 in progress — 5a through 5d complete; 5e next)
...
- **Next planned tasks:** 5e (per-member congressional track records with the guardrails from `congressional-trading.md`: ≥20-trade minimums, matched-random baselines, best-of-N null, split-sample), then Phase 6 paper trading on the portfolio.js engine (which now also has the vol-sizing rule available to run forward).
