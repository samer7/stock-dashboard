...
## Current state (Phase 5 COMPLETE; Phase 6a live — 6b next)
...
- **Next planned tasks:** Phase 6b auto-follow (a second portfolio mechanically running the measured 5d vol-sizing rule forward, sharing the portfolio.js engine's logic), a snapshot-grading report once trades age past their horizons, then the rest of Phase 7 UI polish.
