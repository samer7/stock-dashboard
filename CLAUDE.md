...
- **Next planned tasks:** rest of 5b (calibrated up/down probabilities per horizon — mostly base rates + the vol layer, honestly labeled; Brier/log-loss vs climatology; fitted pieces through walkforward.js), then 5c–5e.
