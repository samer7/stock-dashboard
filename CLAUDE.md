...
- **Next planned tasks:** Phase 6 paper trading on the portfolio.js engine (6a manual, 6b auto-follow live forward-test — the pre-registered arbiter for the 5d vol-sizing rule), then Phase 7 UI polish.
