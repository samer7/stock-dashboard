...
- The first formal research digest is written: `docs/research/ma-timing.md` (11 verified citations; the literature corroborates the harness verdict point for point — no return edge after costs post-1990, drawdown dampening is the robust residual).
- **Next planned tasks:** the digest's falsifiable follow-ups (Faber 10-month SMA and 12-month TSMOM as new harness strategies, crisis-window analysis), then 5b–5e.
