...
## Current state (Phase 5 in progress — 5a, 5b, and 5c complete; 5d/5e next)
...
- **Next planned tasks:** 5d (risk/sizing: Sharpe/Sortino/max-drawdown reporting, Kelly-style position sizing — mostly *reporting* existing measured quantities, no new prediction claims), 5e (per-member congressional track records with the guardrails from `congressional-trading.md`), then Phase 6 paper trading on the portfolio.js engine.
